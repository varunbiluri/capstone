 ...
 * @author (Billuri Varun) @version (26/MAY/2023)
 */
public class Tester
{
    ...
    public void testUniqueIPVisitsOnDay()
    {
        ...
        read.readFile("weblog2_log");
        read.countUniqueIPs();
        ArrayList a = read.uniqueIPVisitsOnDay("Sep 27");
    ...
    public void testCountUniqueIPsInRange()
    {
        LogAnalyzer read =  new  LogAnalyzer();
        read.readFile("weblog2_log");
        System.out.println(read.countUniqueIPsInRange(400, 499));
    }
    ...
    public void testAssignment3()
    {
        ...
        System.out.println(read.iPsWithMostVisitsOnDay(datesIpMap, "Sep 24"));
    }
}
